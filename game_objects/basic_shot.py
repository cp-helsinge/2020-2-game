...
class BasicShot(Gameobject):
  ...
  def __init__(self, boundary = None, position = None, direction = 90, speed = 0):
    ...
    if not BasicShot.loaded:
      BasicShot.sprite = Animation("basic_shot.png",(20,20),(20,20)) 
      BasicShot.loaded = True # Indicate that all common external attributes are loaded
      BasicShot.count += 1
  ...
  def draw(self, surface):
    surface.blit(self.sprite.get_surface(BasicShot.count),self.rect)
